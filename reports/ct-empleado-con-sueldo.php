...
?>
<?php 
$busqueda_trabajador = "SELECT primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, numero_documento, DAY(fecha_ingreso) AS dia_ingreso, MONTH(fecha_ingreso) AS mes_ingreso, YEAR(fecha_ingreso) AS ano_ingreso, sueldo, cargo, direccion_adscrita, tipo_documento FROM trabajadores 
...
WHERE numero_documento = '$trabajador_id'";
        ...
        <strong><?php
            ...
            switch ($mes_ingreso) {
                ...
                case '12':
                    echo "DICIEMBRE";
                    break;
            } ?></strong> del año <strong><?php echo $row["ano_ingreso"] ?></strong>, desempeñando el cargo de
        <strong><?php echo $row["cargo"] ?></strong>, adscrita a la <strong>DIRECCIÓN DE 
