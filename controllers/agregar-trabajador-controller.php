...
$insert_table_trabajadores = "INSERT INTO trabajadores(fecha_ingreso, fecha_egreso, estatus, categoria) VALUES('$fecha_ingreso','$fecha_egreso','$estatus','$categoria')";
   ...
   if ($conn->query($insert_table_trabajadores)) {
    ...
    $insert_table_documentos_de_identidad = "INSERT INTO documentos_identidad(trabajador_fk, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, tipo_documento, numero_documento, pais_nacimiento, estado_civil, fecha_nacimiento, sexo) VALUES('$trabajador_fk','$primer_nombre','$segundo_nombre','$primer_apellido','$segundo_apellido', '$tipo_documento', '$numero_documento', '$pais_nacimiento', '$estado_civil', '$fecha_nacimiento', '$sexo')";
    $conn->query($insert_table_documentos_de_identidad);

    $insert_table_escala_remuneracion = "INSERT INTO escala_remuneracion(trabajador_fk, escala_remuneracion) VALUES('$trabajador_fk', '$escala_remuneracion')";
