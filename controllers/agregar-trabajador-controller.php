...
if (isset($_POST["registrar_trabajador"])) {
   ...
   $comprobar_cedula_sql = "SELECT * FROM documentos_identidad_trabajadores WHERE numero_documento = '$numero_documento'";
   $comprobar_cedula = mysqli_query($conn, $comprobar_cedula_sql);

   if ($comprobar_cedula->num_rows > 0) {
